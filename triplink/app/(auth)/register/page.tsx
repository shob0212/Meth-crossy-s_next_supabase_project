    ...
    <div className="min-h-screen bg-ivory dark:bg-gray-900 flex items-center justify-center p-6 relative">
      <div className="w-full max-w-md animate-fade-in relative z-10">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-[40px] shadow-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden">
          ...
          {step === 'EMAIL' && (
            <>
              <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-8 text-center">{t.register}</h2>
          ...
          {step === 'VERIFY' && (
            <>
              <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-8 text-center">{t.otp}</h2>
          ...
          {step === 'PROFILE' && (
            <>
              <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-8 text-center">{t.setupProfile}</h2>
              <div className="space-y-4">
      ...
      <div className="fixed bottom-8 left-6 z-50">
        <button 
          onClick={() => step === 'EMAIL' ? router.push('/') : setStep(s => s === 'VERIFY' ? 'EMAIL' : 'VERIFY')} 
