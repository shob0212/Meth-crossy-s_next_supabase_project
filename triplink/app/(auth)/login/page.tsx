				...
				<div className="bg-white dark:bg-gray-800 p-8 rounded-[40px] shadow-xl border border-gray-100 dark:border-gray-700 relative overflow-hidden">
					...
					<div className="space-y-4">
						<input
							...
							className="w-full bg-gray-50 dark:bg-gray-700 dark:text-white p-4 rounded-2xl outline-none focus:ring-2 ring-red-200 transition-all"
						/>
						<input
							type="password"
							placeholder={t.pass}
						...
						<button
							type="button"
							onClick={handleLogin}
							className="w-full bg-mint-400 text-white py-4 rounded-full font-bold shadow-md hover:bg-red-500 hover:shadow-lg transition-all"
						>
							{t.login}
						</button>
					</div>
