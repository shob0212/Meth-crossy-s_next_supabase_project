          ...
          <div className="space-y-4">
            {notificationPermission === 'default' && (
              <div className="bg-mint-50 dark:bg-mint-900/20 p-6 rounded-[24px] text-center border border-mint-100 dark:border-mint-900 mb-6">
                ...
                <button onClick={() => setNotificationPermission('granted')} className="bg-mint-400 text-white px-6 py-2 rounded-full font-bold text-sm shadow-md hover:bg-mint-500 transition-colors">
