 ...
 */
export type DashboardTabState = 'HOME' | 'SEARCH' | 'SAVED' | 'NOTIFICATIONS' | 'PROFILE' | 'INVITATIONS' | 'HISTORY' | 'COMPLETED';

/**
 * 旅行詳細タブ状態
 * React最新版(triplink (2))に合わせて統一
 */
export type TripDetailTabState = 'TIMELINE' | 'CALENDAR' | 'MAP' | 'WALLET' | 'BOARD' | 'MEMORIES' | 'BOOKINGS';
