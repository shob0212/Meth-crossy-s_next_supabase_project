  ...
  return (
    <div className="pb-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-[32px] p-8 mb-8 border border-gray-200 dark:border-gray-700 shadow-sm text-center">
        ...
        <h2 className="text-5xl font-light text-gray-800 dark:text-white tracking-tight mb-8">
        ...
        {!isReadOnly && (
          <div className="flex gap-4">
            <button
              ...
              className="flex-1 bg-mint-400 text-white py-4 rounded-full text-sm font-bold shadow-sm hover:bg-mint-500 transition-colors flex items-center justify-center gap-2"
            >
              <Plus size={18} /> {t.record}
            </button>
            <button
              onClick={() => setIsReportModalOpen(true)}
              className="flex-1 bg-ivory dark:bg-gray-700 text-gray-600 dark:text-gray-200 py-4 rounded-full text-sm font-bold border border-gray-200 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
            >
              {t.report}
            </button>
          </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 mb-2 px-1">
          ...
          <h3 className="font-medium text-sm text-gray-500 uppercase tracking-widest">
            {t.history}
          </h3>
        </div>
        {expenses.map((expense) => {
          ...
          return (
            <div
              key={expense.id}
              className="bg-white dark:bg-gray-800 p-6 rounded-[24px] flex items-center justify-between border border-gray-200 dark:border-gray-700 hover:border-mint-200 dark:hover:border-mint-900 transition-all group"
            >
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  ...
                  <p className="text-[10px] text-gray-400 uppercase tracking-wide mt-1 bg-gray-50 dark:bg-gray-700 px-2 py-0.5 rounded-full border border-gray-100 dark:border-gray-600 inline-block">
                ...
                {!isReadOnly && (
                  <div className="hidden group-hover:flex gap-2">
                    <button
                      ...
                      className="text-gray-400 hover:text-mint-400"
                    >
                      <Pencil size={16} />
                    </button>
                    <button
          ...
          <div className="bg-white dark:bg-gray-800 w-full max-w-sm rounded-[32px] p-8 shadow-xl border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-4">
              <input
                ...
                className="w-full bg-ivory dark:bg-gray-700 dark:text-white rounded-2xl p-4 outline-none border border-transparent focus:border-mint-200"
              ...
              <div className="grid grid-cols-2 gap-4">
                <select
                  ...
                  className="bg-ivory dark:bg-gray-700 dark:text-white rounded-2xl p-4 outline-none text-sm border border-transparent focus:border-mint-200"
                >
                  {members.map((m) => (
